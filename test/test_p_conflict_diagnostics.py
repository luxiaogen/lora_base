...
class PConflictNetworkTests(unittest.TestCase):
    ...
    def test_eleven_modes_all_classes_soft_weights_and_no_label_leakage(self):
    ...
    def test_task0_eleven_modes_identical(self):
        self.require_feature()
    ...
    def test_real_learner_trains_three_tasks_and_reports_eleven_modes(self):
        from methods.dlora import Learner
