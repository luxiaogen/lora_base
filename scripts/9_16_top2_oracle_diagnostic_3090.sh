...
cmd=(
  ...
  --set 'seed=[1993]'
  --set prefix=imgr10_top2_oracle_diagnostic_seed1993
  --set max_tasks=10
  ...
  --set wandb_group=top2_oracle_diagnostic_3090
  --set wandb_tags=imgr10,t10,qkv,seed1993,top2_coverage,oracle_diagnostic
)
