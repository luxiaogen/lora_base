...
LOG_DIR=logs/shell_logs/lora_inherit_3090
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
FAILED=0
mkdir -p "$LOG_DIR"

echo "============================================================"
echo "Starting cub10_fresh_seed1993"
echo "Changed: Fresh A/B each task; full QKV baseline"
echo "Log: $LOG_DIR/cub10_fresh_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cub10.json \
        --set 'seed=[1993]' \
        --set "prefix=cub10_fresh_seed1993_${TIMESTAMP}" \
        ...
        2>&1 | tee "$LOG_DIR/cub10_fresh_seed1993_${TIMESTAMP}.log"
then
    echo "PASS cub10_fresh_seed1993"
else
    echo "FAIL cub10_fresh_seed1993"
    FAILED=1
fi

echo "============================================================"
echo "Starting cub10_inherit_seed1993"
echo "Changed: Inherit A/B; centered BA-BA_start, full QKV"
echo "Log: $LOG_DIR/cub10_inherit_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cub10.json \
        --set 'seed=[1993]' \
        --set "prefix=cub10_inherit_seed1993_${TIMESTAMP}" \
        --set total_sessions=10 \
        --set init_cls=20 \
        --set increment=20 \
        --set max_tasks=10 \
        ...
        2>&1 | tee "$LOG_DIR/cub10_inherit_seed1993_${TIMESTAMP}.log"
then
    echo "PASS cub10_inherit_seed1993"
else
    echo "FAIL cub10_inherit_seed1993"
    FAILED=1
fi

echo "============================================================"
echo "Starting cub10_fresh_seed1996"
echo "Changed: Fresh A/B each task; full QKV baseline"
echo "Log: $LOG_DIR/cub10_fresh_seed1996_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cub10.json \
        --set 'seed=[1996]' \
        --set "prefix=cub10_fresh_seed1996_${TIMESTAMP}" \
        --set total_sessions=10 \
        --set init_cls=20 \
        --set increment=20 \
        --set max_tasks=10 \
        ...
        --set plora_gamma=0.75 \
        --set dual_mask_lora_inherit=false \
        2>&1 | tee "$LOG_DIR/cub10_fresh_seed1996_${TIMESTAMP}.log"
then
    echo "PASS cub10_fresh_seed1996"
else
    echo "FAIL cub10_fresh_seed1996"
    FAILED=1
fi

echo "============================================================"
echo "Starting cub10_inherit_seed1996"
echo "Changed: Inherit A/B; centered BA-BA_start, full QKV"
echo "Log: $LOG_DIR/cub10_inherit_seed1996_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cub10.json \
        --set 'seed=[1996]' \
        --set "prefix=cub10_inherit_seed1996_${TIMESTAMP}" \
        --set total_sessions=10 \
        --set init_cls=20 \
        --set increment=20 \
        --set max_tasks=10 \
        ...
        --set plora_gamma=0.75 \
        --set dual_mask_lora_inherit=true \
        2>&1 | tee "$LOG_DIR/cub10_inherit_seed1996_${TIMESTAMP}.log"
then
    echo "PASS cub10_inherit_seed1996"
else
    echo "FAIL cub10_inherit_seed1996"
    FAILED=1
fi

echo "============================================================"
echo "Starting cub10_fresh_seed1997"
echo "Changed: Fresh A/B each task; full QKV baseline"
echo "Log: $LOG_DIR/cub10_fresh_seed1997_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cub10.json \
        --set 'seed=[1997]' \
        --set "prefix=cub10_fresh_seed1997_${TIMESTAMP}" \
        --set total_sessions=10 \
        --set init_cls=20 \
        --set increment=20 \
        --set max_tasks=10 \
        ...
        --set plora_gamma=0.75 \
        --set dual_mask_lora_inherit=false \
        2>&1 | tee "$LOG_DIR/cub10_fresh_seed1997_${TIMESTAMP}.log"
then
    echo "PASS cub10_fresh_seed1997"
else
    echo "FAIL cub10_fresh_seed1997"
    FAILED=1
fi

echo "============================================================"
echo "Starting cub10_inherit_seed1997"
echo "Changed: Inherit A/B; centered BA-BA_start, full QKV"
echo "Log: $LOG_DIR/cub10_inherit_seed1997_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cub10.json \
        --set 'seed=[1997]' \
        --set "prefix=cub10_inherit_seed1997_${TIMESTAMP}" \
        --set total_sessions=10 \
        --set init_cls=20 \
        --set increment=20 \
        --set max_tasks=10 \
        ...
        --set plora_gamma=0.75 \
        --set dual_mask_lora_inherit=true \
        2>&1 | tee "$LOG_DIR/cub10_inherit_seed1997_${TIMESTAMP}.log"
then
    echo "PASS cub10_inherit_seed1997"
else
    echo "FAIL cub10_inherit_seed1997"
    FAILED=1
fi

echo "============================================================"
echo "Finished 6 runs for lora_inherit_3090; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
