...
cmd=(
  ...
  --set 'seed=[1993]'
  --set prefix=imgr10_top2_top_class_gain_seed1993
  --set max_tasks=10
  ...
  --set wandb_group=top2_top_class_gain_validation
  --set wandb_tags=imgr10,t10,qkv,seed1993,top2,top_class_gain,diagnostic
)
