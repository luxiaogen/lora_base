...
LOG_DIR=logs/shell_logs/suppress_anchor_task0_energy50_floor10_4datasets_3seeds
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
FAILED=0
mkdir -p "$LOG_DIR"

echo "============================================================"
echo "Starting cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1993"
...
echo "Log: $LOG_DIR/cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cifar10.json \
        --set 'seed=[1993]' \
        --set prefix=cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1993 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set ca=true \
        --set ca_epochs=10 \
        ...
        --set wandb_group=suppress_anchor_task0_energy50_floor10_4datasets_3seeds \
        --set rank=32 \
        --set wandb_tags=cifar100,t10,suppress,energy50,floor10,anchor_task0,w10,multiseed \
        2>&1 | tee "$LOG_DIR/cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1993_${TIMESTAMP}.log"
then
    echo "PASS cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1993"
else
    echo "FAIL cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1993"
    FAILED=1
fi

echo "============================================================"
echo "Starting cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1996"
echo "Changed: Suppress merge with Task-0 W0 anchor w10 and the smallest conflict set satisfying both 50 percent energy coverage and a 10 percent coordinate floor"
echo "Log: $LOG_DIR/cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1996_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cifar10.json \
        --set 'seed=[1996]' \
        --set prefix=cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1996 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set ca=true \
        --set ca_epochs=10 \
        ...
        --set rank=32 \
        --set wandb_tags=cifar100,t10,suppress,energy50,floor10,anchor_task0,w10,multiseed \
        2>&1 | tee "$LOG_DIR/cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1996_${TIMESTAMP}.log"
then
    echo "PASS cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1996"
else
    echo "FAIL cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1996"
    FAILED=1
fi

echo "============================================================"
echo "Starting cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1997"
echo "Changed: Suppress merge with Task-0 W0 anchor w10 and the smallest conflict set satisfying both 50 percent energy coverage and a 10 percent coordinate floor"
echo "Log: $LOG_DIR/cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1997_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/cifar10.json \
        --set 'seed=[1997]' \
        --set prefix=cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1997 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set ca=true \
        --set ca_epochs=10 \
        ...
        --set rank=32 \
        --set wandb_tags=cifar100,t10,suppress,energy50,floor10,anchor_task0,w10,multiseed \
        2>&1 | tee "$LOG_DIR/cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1997_${TIMESTAMP}.log"
then
    echo "PASS cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1997"
else
    echo "FAIL cifar100_t10_suppress_anchor_task0_w10_energy50_floor10_seed1997"
    FAILED=1
fi
...
if
    python main.py --config exps/dlora/cub10.json \
        ...
        --set wandb_group=suppress_anchor_task0_energy50_floor10_4datasets_3seeds \
        --set rank=32 \
        --set wandb_tags=cub200,t10,suppress,energy50,floor10,anchor_task0,w10,multiseed \
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set wandb_group=suppress_anchor_task0_energy50_floor10_4datasets_3seeds \
        --set rank=64 \
        --set wandb_tags=imagenet_r,t10,suppress,energy50,floor10,anchor_task0,w10,multiseed \
...
if
    python main.py --config exps/dlora/imga10.json \
        ...
        --set wandb_group=suppress_anchor_task0_energy50_floor10_4datasets_3seeds \
        --set rank=32 \
        --set wandb_tags=imagenet_a,t10,suppress,energy50,floor10,anchor_task0,w10,multiseed \
...
echo "============================================================"
echo "Finished 12 runs for suppress_anchor_task0_energy50_floor10_4datasets_3seeds; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
