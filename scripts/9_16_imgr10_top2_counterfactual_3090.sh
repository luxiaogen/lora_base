...
cmd=(
  ...
  --set 'seed=[1993]'
  --set prefix=imgr10_top2_counterfactual_seed1993
  --set max_tasks=10
  ...
  --set wandb_group=imgr10_top2_counterfactual_3090
  --set wandb_tags=imgr10,t10,qkv,seed1993,top2_counterfactual,p_conflict,inference_only
)
...
python -m unittest \
  ...
  test.test_top2_counterfactual_script
