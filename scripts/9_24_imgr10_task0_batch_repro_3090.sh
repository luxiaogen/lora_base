...
git status --short
LOG_DIR=logs/shell_logs/imgr10_task0_batch_repro_3090
...
echo "Changed: Identical Task0 seed1993, batch trace 1"
echo "Log: $LOG_DIR/imgr10_task0_repeat1_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_task0_batch_repeat1_seed1993_${TIMESTAMP}" \
        --set max_tasks=1 \
        --set init_epoch=1 \
        --set epochs=20 \
        --set init_cls=20 \
        ...
        --set wandb_group=imgr10_task0_batch_repro_3090 \
...
echo "Changed: Identical Task0 seed1993, batch trace 2"
echo "Log: $LOG_DIR/imgr10_task0_repeat2_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_task0_batch_repeat2_seed1993_${TIMESTAMP}" \
        --set max_tasks=1 \
        --set init_epoch=1 \
        --set epochs=20 \
        --set init_cls=20 \
...
echo "============================================================"
echo "Finished 2 runs for imgr10_task0_batch_repro_3090; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
