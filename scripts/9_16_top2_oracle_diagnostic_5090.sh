...
cmd=(
  ...
  --set 'seed=[1993]'
  --set prefix=imgr20_top2_oracle_diagnostic_seed1993
  --set max_tasks=20
  ...
  --set wandb_group=top2_oracle_diagnostic_5090
  --set wandb_tags=imgr20,t20,qkv,seed1993,top2_coverage,oracle_diagnostic
)
...
python -m unittest \
  ...
  test.test_top2_oracle_diagnostic_scripts
