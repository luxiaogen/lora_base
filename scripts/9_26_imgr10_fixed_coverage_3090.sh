...
git status --short
LOG_DIR=logs/shell_logs/imgr10_fixed_coverage_3090
...
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_t10_coverage010_seed1993_3090_${TIMESTAMP}" \
        ...
        --set wandb_group=imgr10_fixed_coverage_3090 \
...
echo "============================================================"
echo "Starting imgr10_t10_coverage000_seed1993"
echo "Changed: Fixed conflict coverage 0%; beta=0.5"
echo "Log: $LOG_DIR/imgr10_t10_coverage000_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_t10_coverage000_seed1993_3090_${TIMESTAMP}" \
        --set dataset=ImageNet_R \
        --set memory_size=0 \
        --set memory_per_class=0 \
        --set fixed_memory=true \
        ...
        "$@" \
        2>&1 | tee "$LOG_DIR/imgr10_t10_coverage000_seed1993_${TIMESTAMP}.log"
then
    echo "PASS imgr10_t10_coverage000_seed1993"
else
    echo "FAIL imgr10_t10_coverage000_seed1993"
    FAILED=1
fi

echo "============================================================"
echo "Starting imgr10_t10_coverage040_seed1993"
echo "Changed: Fixed conflict coverage 40%; beta=0.5"
echo "Log: $LOG_DIR/imgr10_t10_coverage040_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_t10_coverage040_seed1993_3090_${TIMESTAMP}" \
        --set dataset=ImageNet_R \
        --set memory_size=0 \
        --set memory_per_class=0 \
        --set fixed_memory=true \
        ...
        --set dual_mask_conflict_exact_topk=true \
        --set ca_real_new_features=false \
        --set dual_mask_conflict_ratio=0.4 \
        "$@" \
        2>&1 | tee "$LOG_DIR/imgr10_t10_coverage040_seed1993_${TIMESTAMP}.log"
then
    echo "PASS imgr10_t10_coverage040_seed1993"
else
    echo "FAIL imgr10_t10_coverage040_seed1993"
    FAILED=1
fi

echo "============================================================"
echo "Starting imgr10_t10_coverage060_seed1993"
echo "Changed: Fixed conflict coverage 60%; beta=0.5"
echo "Log: $LOG_DIR/imgr10_t10_coverage060_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_t10_coverage060_seed1993_3090_${TIMESTAMP}" \
        --set dataset=ImageNet_R \
        --set memory_size=0 \
        --set memory_per_class=0 \
        --set fixed_memory=true \
        ...
        --set dual_mask_conflict_exact_topk=true \
        --set ca_real_new_features=false \
        --set dual_mask_conflict_ratio=0.6 \
        "$@" \
        2>&1 | tee "$LOG_DIR/imgr10_t10_coverage060_seed1993_${TIMESTAMP}.log"
then
    echo "PASS imgr10_t10_coverage060_seed1993"
else
    echo "FAIL imgr10_t10_coverage060_seed1993"
    FAILED=1
fi

echo "============================================================"
echo "Finished 4 runs for imgr10_fixed_coverage_3090; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
