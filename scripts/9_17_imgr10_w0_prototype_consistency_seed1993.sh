...
cmd=(
  ...
  --set 'seed=[1993]'
  --set prefix=imgr10_w0_prototype_consistency_seed1993
  --set max_tasks=10
  ...
  --set wandb_group=w0_prototype_consistency_validation
  --set wandb_tags=imgr10,t10,qkv,seed1993,p_conflict,w0_prototype,diagnostic
)
