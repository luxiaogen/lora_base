...
git status --short
LOG_DIR=logs/shell_logs/imgr10_task0_repro_3090
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set wandb_group=imgr10_task0_repro_3090 \
...
echo "Changed: Identical Task0 seed1993, repeat 2"
echo "Log: $LOG_DIR/imgr10_task0_repeat2_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_task0_repeat2_seed1993_${TIMESTAMP}" \
        --set max_tasks=1 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set init_cls=20 \
...
echo "Changed: Identical Task0 seed1993, repeat 3"
echo "Log: $LOG_DIR/imgr10_task0_repeat3_seed1993_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1993]' \
        --set "prefix=imgr10_task0_repeat3_seed1993_${TIMESTAMP}" \
        --set max_tasks=1 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set init_cls=20 \
...
echo "============================================================"
echo "Finished 3 runs for imgr10_task0_repro_3090; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
