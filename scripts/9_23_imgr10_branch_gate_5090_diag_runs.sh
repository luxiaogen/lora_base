...
cd "$(dirname "$0")/.."
LOG_DIR=logs/shell_logs/imgr10_branch_gate_5090_diag
...
echo "Changed: A paired baseline on 5090D: S protect+conflict; P plastic+conflict"
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set 'wandb_tags=["imgr10","branch_gate","5090","a_baseline"]' \
...
echo "Changed: C on 5090D: zero S/P conflict strength; retain S protect and P plastic mask"
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set wandb_mode=online \
        --set wandb_group=imgr10_branch_gate_2machine \
        --set 'wandb_tags=["imgr10","branch_gate","5090","c_all_conflict_off"]' \
...
echo "Changed: D on 5090D: disable only S protection gate; retain S/P conflict and P plastic mask"
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set wandb_mode=online \
        --set wandb_group=imgr10_branch_gate_2machine \
        --set 'wandb_tags=["imgr10","branch_gate","5090","d_s_protect_off"]' \
...
echo "============================================================"
echo "Finished 3 runs for imgr10_branch_gate_5090_diag; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
