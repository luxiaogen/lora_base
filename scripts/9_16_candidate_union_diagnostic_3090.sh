...
cmd=(
  ...
  --set 'seed=[1993]'
  --set prefix=imgr10_candidate_union_diagnostic_seed1993
  --set max_tasks=10
  ...
  --set wandb_group=candidate_union_diagnostic_3090
  --set wandb_tags=imgr10,t10,qkv,seed1993,candidate_union,evidence_gain,diagnostic
)
