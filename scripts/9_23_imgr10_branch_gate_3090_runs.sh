...
cd "$(dirname "$0")/.."
LOG_DIR=logs/shell_logs/imgr10_branch_gate_3090
...
echo "Changed: A paired baseline on 3090: S protect+conflict; P plastic+conflict"
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set 'wandb_tags=["imgr10","branch_gate","3090","a_baseline"]' \
...
echo "Changed: B on 3090: disable only P conflict gate; retain S protect/conflict and P plastic mask"
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set wandb_mode=online \
        --set wandb_group=imgr10_branch_gate_2machine \
        --set 'wandb_tags=["imgr10","branch_gate","3090","b_p_conflict_off"]' \
...
echo "============================================================"
echo "Finished 4 runs for imgr10_branch_gate_3090; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
