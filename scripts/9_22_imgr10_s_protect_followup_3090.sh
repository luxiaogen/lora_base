...
cd "$(dirname "$0")/.."
LOG_DIR=logs/shell_logs/imgr10_s_protect_followup
...
echo "============================================================"
echo "Starting imgr10_a_baseline_seed1996"
echo "Changed: Paired baseline: keep S protection and S/P conflict control"
echo "Log: $LOG_DIR/imgr10_a_baseline_seed1996_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1996]' \
        --set prefix=imgr10_a_baseline_seed1996 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set rank=64 \
        --set ca=true \
        ...
        --set wandb_group=imgr10_s_protect_followup_3090 \
        --set dual_mask_s_protect_enabled=true \
        --set 'wandb_tags=["imgr10","s_protect","baseline"]' \
        2>&1 | tee "$LOG_DIR/imgr10_a_baseline_seed1996_${TIMESTAMP}.log"
then
    echo "PASS imgr10_a_baseline_seed1996"
else
    echo "FAIL imgr10_a_baseline_seed1996"
    FAILED=1
fi

echo "============================================================"
echo "Starting imgr10_d_s_protect_off_seed1996"
echo "Changed: Disable only S protection; retain S/P conflict and P plastic mask"
echo "Log: $LOG_DIR/imgr10_d_s_protect_off_seed1996_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1996]' \
        --set prefix=imgr10_d_s_protect_off_seed1996 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set rank=64 \
        --set ca=true \
        ...
        --set 'wandb_tags=["imgr10","s_protect","off"]' \
        2>&1 | tee "$LOG_DIR/imgr10_d_s_protect_off_seed1996_${TIMESTAMP}.log"
then
    echo "PASS imgr10_d_s_protect_off_seed1996"
else
    echo "FAIL imgr10_d_s_protect_off_seed1996"
    FAILED=1
fi
...
echo "============================================================"
echo "Starting imgr10_d_s_protect_off_seed1997"
echo "Changed: Disable only S protection; retain S/P conflict and P plastic mask"
echo "Log: $LOG_DIR/imgr10_d_s_protect_off_seed1997_${TIMESTAMP}.log"
echo "============================================================"
if
    python main.py --config exps/dlora/imgr10.json \
        --set 'seed=[1997]' \
        --set prefix=imgr10_d_s_protect_off_seed1997 \
        --set init_epoch=20 \
        --set epochs=20 \
        --set rank=64 \
        --set ca=true \
        ...
        --set dual_mask_s_protect_enabled=false \
        --set 'wandb_tags=["imgr10","s_protect","off"]' \
        2>&1 | tee "$LOG_DIR/imgr10_d_s_protect_off_seed1997_${TIMESTAMP}.log"
then
    echo "PASS imgr10_d_s_protect_off_seed1997"
else
    echo "FAIL imgr10_d_s_protect_off_seed1997"
    FAILED=1
fi

echo "============================================================"
echo "Finished 4 runs for imgr10_s_protect_followup; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
