...
LOG_DIR=logs/shell_logs/task_consistency_imgr10_3090
...
echo "Changed: Cross-GPU replication of the full T10 task-consistency diagnostic"
...
if
    python main.py --config exps/dlora/imgr10.json \
        ...
        --set wandb_tags=imgr10,t10,qkv,seed1993,task_consistency,p_conflict,diagnostic \
        --set rank=64 \
...
echo "============================================================"
echo "Finished 1 runs for task_consistency_imgr10_3090; FAILED=$FAILED"
echo "Logs: $LOG_DIR"
echo "============================================================"
exit $FAILED
