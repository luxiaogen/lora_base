...
class AngularPenaltySMLoss(nn.Module):
    ...
    def forward(self, wf, labels, return_type='batch_mean'):
        if self.loss_type == 'crossentropy':
            ...
            if return_type == 'batch_mean':
                return -torch.mean(L)
            elif return_type == 'per_sample':
                return -L
